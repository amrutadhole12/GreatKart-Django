...
def payments(request):
    ...
    #send order  number and transaction id back to send data method via json responce
...
def place_order(request, total=0, quantity=0):
    ...
    # if the cart count is less than equal to 0, then redirect to shop
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            #store all the biling info inside order table
            data = Order()
